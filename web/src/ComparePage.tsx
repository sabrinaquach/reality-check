...
export function ComparePage({
  ...
  return (
    <div className={inline ? "rc cmp rc-inline" : "rc cmp"}>
      {onBack && (
      ...
      {/* The two column headers, and the only place the full address appears.
          Each is a button: having compared them, the next thing anyone wants is
          the whole reality check for the one that won. */}
